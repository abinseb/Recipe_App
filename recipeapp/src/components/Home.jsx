import { Button, Card, CardContent, CardMedia, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, InputLabel, MenuItem, Select, TextField, Typography } from '@mui/material';
...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:3016/viewcuisine')
      .then((res) => {
  ...
  return (
    <>
    {loading?<CircularProgress color='primary' />:<div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '5px', paddingBottom: '60px', paddingTop: '30px' }}>
        {fdata.map((val, i) => (
          <Card key={i}>
            <CardMedia>
      ...
      <Dialog open={openDialog} onClose={handleDialogClose}>
        ...
        <DialogActions>
        <Button style={{paddingLeft:'10px'}} onClick={handleDialogClose}>Cancel</Button>
