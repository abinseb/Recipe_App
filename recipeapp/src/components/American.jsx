...
const American = () => {
    ...
    useEffect(()=>{
        ...
        .then((res)=>{
            ...
            const americanCuisineData = res.data.filter((item)=>item.cuisineType == 'American');
            setAmerican(americanCuisineData);
    ...
    const handleDelete = (id, imageName) => {
      ...
      axios
        ...
        .then(() => {
          setAmerican((prevData) => prevData.filter((item) => item._id !== id));
