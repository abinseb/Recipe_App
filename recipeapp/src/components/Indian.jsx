  ...
  const [formData, setFormData] = useState({
    ...
    useEffect(()=>{
        ...
        .then((res)=>{
            ...
            const indianCuisineData = res.data.filter((item)=>item.cuisineType == 'Indian');
            setIndian(indianCuisineData);
        })
    ...
    const handleDelete = (id, imageName) => {
      ...
      axios
        ...
        .then(() => {
          setIndian((prevData) => prevData.filter((item) => item._id !== id));
