...
const Chinese = () => {
    ...
    useEffect(()=>{
        ...
        .then((res)=>{
            ...
            const chineseCuisineData = res.data.filter((item)=>item.cuisineType == 'Chinese');
            setChinese(chineseCuisineData);
    ...
    const handleDelete = (id, imageName) => {
      ...
      axios
        ...
        .then(() => {
          setChinese((prevData) => prevData.filter((item) => item._id !== id));
